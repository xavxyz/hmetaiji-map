...
locations.forEach((location) => {
  ...
  new mapboxgl.Marker(markerEl).setLngLat(location.coordinates).addTo(map);
});
...
function showLocation(location) {
  ...
  document.getElementById("title").textContent = location.city;
  document.getElementById("address").textContent = location.address;
  document.getElementById("activity").textContent = location.activity;
  document.getElementById("description").textContent = location.description;
  document.getElementById("infos").textContent = location.infos;
  document.getElementById("link").href = location.link;
}
