...
- [docs/environments.md](docs/environments.md) — production, staging and deploy previews on one Netlify site. Read before touching deploy contexts, per-context variables, or the build badge.
